...
/+ #endif +/ // Q_CLANG_QDOC
    ...
    final bool wait(int timeout = 5000)
    {
        ...
        const(int) origCount = collectedSignals.count();
        m_waiting = true;
        m_loop = loop;
        m_loop.enterLoopMSecs(timeout);
        m_loop = null;
        m_waiting = false;
        return collectedSignals.count() > origCount;
    }
